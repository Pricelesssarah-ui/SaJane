...
//Our Menu
 ...
 let appetizer = document.querySelector('.btn-appetizer');
 let mainCourse = document.querySelector('.btn-mainCourse');
 let sideDish = document.querySelector('.btn-sideDish');
 let sauce = document.querySelector('.btn-sauce');
 let specialDish = document.querySelector('.btn-specialDish');



 let containerAll = document.querySelector('.container-all');
 let containerAppetizer = document.querySelector('.container-appetizer');
 let containerMaincourse = document.querySelector('.container-maincourse');
 let containerSidedish = document.querySelector('.container-sidedish');
 let containerSauce = document.querySelector('.container-sauce');
 let containerSpecialdish = document.querySelector('.container-specialdish');
